// NOTE: This API route is NOT included in the static export (output: "export").
// For Cloudflare Pages deployment, replace this with a third-party form service
// such as Formspree (formspree.io) or Web3Forms (web3forms.com).
// Update components/forms/ContactForm.tsx to POST to the third-party endpoint.
